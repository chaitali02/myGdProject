...
Copy account_status_type(account_status_id,account_status_code,account_status_desc,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/account_status_type.csv' delimiter ',';

Copy account_type(account_type_id,account_type_code,account_type_desc,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/account_type.csv' delimiter ',';

Copy address(address_id,address_line1,address_line2,address_line3,city,county,state,zipcode,country,latitude,longitude,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/address.csv' delimiter ',';

Copy bank(bank_id,bank_code,bank_name,bank_account_number,bank_currency_code,bank_check_digits,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/bank.csv' delimiter ',';

Copy branch(branch_id,branch_type_id,bank_id,address_id,branch_name,branch_desc,branch_contact_name,branch_contact_phone,branch_contact_email,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/branch.csv' delimiter ',';

Copy .branch_type(branch_type_id,branch_type_code,branch_type_desc,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/branch_type.csv' delimiter ',';

Copy customer(customer_id,address_id,branch_id,title,first_name,middle_name,last_name,ssn,phone,date_first_purchase,commute_distance_miles,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/customer.csv' delimiter ',';

Copy dim_date(date_id,date_type,date_val,day_num_of_week,day_num_of_month,day_num_of_quarter,day_num_of_year,day_num_absolute,day_of_week_name,day_of_week_abbreviation,julian_day_num_of_year,julian_day_num_absolute,is_weekday,is_usa_civil_holiday,is_last_day_of_week,is_last_day_of_month,is_last_day_of_quarter,is_last_day_of_year,is_last_day_of_fiscal_month,is_last_day_of_fiscal_quarter,is_last_day_of_fiscal_year,week_of_year_begin_date,week_of_year_begin_date_key,week_of_year_end_date,week_of_year_end_date_key,week_of_month_begin_date,week_of_month_begin_date_key,week_of_month_end_date,week_of_month_end_date_key,week_of_quarter_begin_date,week_of_quarter_begin_date_key,week_of_quarter_end_date,week_of_quarter_end_date_key,week_num_of_month,week_num_of_quarter,week_num_of_year,month_num_of_year,month_num_overall,month_name,month_name_abbreviation,month_begin_date,month_begin_date_key,month_end_date,month_end_date_key,quarter_num_of_year,quarter_num_overall,quarter_begin_date,quarter_begin_date_key,quarter_end_date,quarter_end_date_key,year_num,year_begin_date,year_begin_date_key,year_end_date,year_end_date_key,yyyy_mm,yyyy_mm_dd,dd_mon_yyyy,load_date)FROM '/user/hive/warehouse/framework/upload/dim_date.csv' delimiter ',';

Copy product_type(product_type_id,product_type_code,product_type_desc,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/product_type.csv' delimiter ',';

Copy transaction(transaction_id,transaction_type_id,account_id,transaction_date,from_account,to_account,amount_base_curr,amount_usd,currency_code,currency_rate,notes,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/transaction.csv' delimiter ',';

Copy transaction_type(transaction_type_id,transaction_type_code,transaction_type_desc,load_date, load_id)FROM '/user/hive/warehouse/framework/upload/transaction_type.csv' delimiter ',';
