...
(
SELECT 'ACCOUNT_POSTGRES' AS TABNAME, COUNT(*) AS CNT FROM ACCOUNT_POSTGRES
UNION
...
UNION
SELECT 'FACT_CUSTOMER_SUMMARY_MONTHLY' AS TABNAME, COUNT(*) AS CNT FROM FACT_ACCOUNT_SUMMARY_MONTHLY
UNION
