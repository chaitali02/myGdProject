...
LOAD DATA LOCAL INFILE '/user/hive/warehouse/framework/upload/customer_idiosyncratic_risk.csv' IGNORE INTO TABLE customer_idiosyncratic_risk FIELDS TERMINATED BY ',' ENCLOSED BY '"' ESCAPED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE '/user/hive/warehouse/framework/upload/industry_factor_simulation.csv' IGNORE INTO TABLE industry_factor_simulation FIELDS TERMINATED BY ',' ENCLOSED BY '"' ESCAPED BY '"' LINES TERMINATED BY '\n' IGNORE 1 LINES;
