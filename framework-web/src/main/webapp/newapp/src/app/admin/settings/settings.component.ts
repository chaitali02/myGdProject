...
export class SettingsComponent implements OnInit {
    ...
    constructor(private _datapodService : DatapodService,private datePipe: DatePipe,config: AppConfig,private _commonService: CommonService, private activatedRoute: ActivatedRoute, public router: Router, private _settingsService: SettingsService) {
...
//--
    ...
    callBulidGraph(){
        ...
        //SettingsService.buildGraph().then(function (response) { onSuccesscallBulidGraph(response.data) });
