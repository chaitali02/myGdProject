  ...
  $scope.close = function () {
    if ($stateParams.returnBack == "true" && $rootScope.previousState) {
      ...
      if($rootScope.previousState.name!="resultgraphwf"){
        ...
        stateTabPrevious.route=dagMetaDataService.elementDefs['predictexec'].detailState;;
        ...
        stateTabPrevious.param.type = dagMetaDataService.elementDefs['predictexec'].execType;
