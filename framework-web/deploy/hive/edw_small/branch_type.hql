...
LOAD DATA LOCAL INPATH '/user/hive/warehouse/edw_small/upload/branch_type_small.csv' OVERWRITE INTO TABLE edw_small.branch_type PARTITION (load_date='2017-07-01', load_id='00'); 
