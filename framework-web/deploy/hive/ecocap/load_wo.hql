...
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/upload/customer_portfolio_2018.csv' OVERWRITE INTO TABLE customer_portfolio;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/upload/industry_factor_correlation_transpose_2018.csv' OVERWRITE INTO TABLE industry_factor_correlation_transpose;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/upload/industry_factor_correlation_2018.csv' OVERWRITE INTO TABLE industry_factor_correlation;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/upload/industry_factor_mean_2018.csv' OVERWRITE INTO TABLE industry_factor_mean;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/upload/industry_factor_simulation_2018.csv' OVERWRITE INTO TABLE industry_factor_simulation;
