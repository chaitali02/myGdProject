...
InferyxApp.factory('dagValidationSvc',function(dagMetaDataService){
  ...
  obj.validate = function (graph,cellViewS, magnetS, cellViewT, magnetT, end, linkView) {
    ...
    isValid = dagToStage(sType,tType,inboundLinks) || stageToStage(sType,tType,inboundLinks,outboundLinks) || stageToTask(sType,tType,inboundLinks) || taskToTask(sType,tType,inboundLinks,graph,cellViewS,cellViewT);
    return isValid;
  };
  return obj;
});
