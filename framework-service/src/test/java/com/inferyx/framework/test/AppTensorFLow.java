 ...
 *
 */
public class AppTensorFLow
{
    public static void main( String[] args )
    {
      System.out.println( "TensorFlow model Example...!! \nI'm using tensorflow version " + TensorFlow.version()+"\n\n");

      try {
        MnistReader mrTest = new MnistReader("/home/gridedge-5/Desktop/test_tensorflow/t10k-labels.idx1-ubyte", "/home/gridedge-5/Desktop/test_tensorflow/t10k-images-idx3-ubyte");

        SavedModelBundle smb = SavedModelBundle.load("/home/gridedge-5/Desktop/test_tensorflow/model", "serve");
