...
export class LoadComponent {
  ...
  onSuccessgetOneByUuidAndVersion(response){
    ...
    // this.targets["uuid"]=this.loadData.target.ref.uuid
    // this.targets["name"]=this.loadData.target.ref.name
   ...
   // if(this.active === 'Y') { this.active = true; } else { this.active = false; }
    ...
    //  if(this.header === 'Y') { this.header = true; } else { this.header = false; }
    // this.append = response['append'];
    //  if(this.append === 'Y') { this.append = true; } else { this.append = false; }
