...
public class ProfileController {
	...
	public List<Map<String, Object>> getResults(@RequestParam("uuid") String profileExecUUID, @RequestParam("version") String profileExecVersion,
		...
		Mode runMode = Helper.getExecutionMode(mode);
		return profileServiceImpl.getProfileResults(profileExecUUID, profileExecVersion, offset,limit,sortBy,order,requestId, runMode);
	}
