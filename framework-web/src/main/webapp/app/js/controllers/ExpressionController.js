...
MetadataModule.controller('MetadataExpressionController',function($state,$scope,$stateParams,$cookieStore,$sessionStorage,MetadataExpressionSerivce,privilegeSvc){
	...
	$scope.showExpressionPage=function(){
		$scope.showexpression=true;
		$scope.showgraph=false
		$scope.graphDataStatus=false;
		$scope.showgraphdiv=false
  ...
  $scope.$watch("isshowmodel",function(newvalue,oldvalue){
	...
	$scope.showExpressionGraph=function(uuid,version){
