...
DatavisualizationModule.directive('bubbleChart', function (sortFactory, COLORPALETTE) {
  return {
    scope: {
      data: "=",
      column: "=",
    ...
    link: function ($scope, element, attrs) {
      $scope.$watch('data', function (newValue, oldValue) {
        $scope.chartcolor = COLORPALETTE.Random_4//["#d98880", "#f1948a", "#c39bd3", "#bb8fce", "#7fb3d5", "#85c1e9", "#76d7c4", "#73c6b6", "#7dcea0", "#82e0aa", "#f7dc6f", "#f8c471", "#f0b27a", "#e59866"] //["#E6B0AA","#D7BDE2","#F5B7B1","#D2B4DE","#A9CCE3","#AED6F1","#A9CCE3","#A3E4D7","#A2D9CE","#A9DFBF","#ABEBC6","#F9E79F","#FAD7A0","#F5CBA7","#EDBB99"]
        if($scope.column.colorPalette !=null && ($scope.column.colorPalette !="Standard" )){
          var str=$scope.column.colorPalette.replace(" ", "_");
       ...
       // console.log(keyname)
        ...
        data.color = function (color, d) {
          return $scope.chartcolor[Math.floor((Math.random() *$scope.chartcolor.length-1) + 0)] //'#'+Math.random().toString(16).substr(2,6);
        }
