  ...
  CREATE TABLE "XE"."DIM_ADDRESS" 
   (	"ADDRESS_ID" VARCHAR2(70 BYTE) NOT NULL ENABLE, 
	...
	"LOAD_ID" NUMBER(30,0) DEFAULT 0, 
	 CONSTRAINT "DIM_ADDRESS_PK" PRIMARY KEY ("ADDRESS_ID", "LOAD_DATE") DISABLE, 
	 CONSTRAINT "DIM_ADDRESS_UK1" UNIQUE ("SRC_ADDRESS_ID", "LOAD_DATE", "LOAD_ID") DISABLE
