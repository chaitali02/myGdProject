...
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/app/ecocap/data/csv/noheader/customer_portfolio_1000.csv' OVERWRITE INTO TABLE CUSTOMER_PORTFOLIO;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/app/ecocap/data/csv/noheader/industry_factor_correlation_transpose.csv' OVERWRITE INTO TABLE industry_factor_correlation_transpose;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/app/ecocap/data/csv/noheader/industry_factor_correlation.csv' OVERWRITE INTO TABLE INDUSTRY_FACTOR_CORRELATION;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/app/ecocap/data/csv/noheader/industry_factor_mean.csv' OVERWRITE INTO TABLE INDUSTRY_FACTOR_MEAN;
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/app/ecocap/data/csv/noheader/lkp_reporting_date.csv' OVERWRITE INTO TABLE LKP_REPORTING_DATE;  
LOAD DATA LOCAL INPATH '/user/hive/warehouse/framework/app/ecocap/data/csv/noheader/portfolio_var_heatmap_buckets.csv' OVERWRITE INTO TABLE PORTFOLIO_VAR_HEATMAP_BUCKETS;