...
(function ($) {
    ...
    JFilestyle.prototype = {
        ...
        htmlInput: function () {
            if (this.options.input) {
                return '<input class="col-md-8"type="text" style="padding-right:0px" placeholder="'+ this.options.placeholder +'" > ';
            } else {
                return '';
            }
        },
        ...
        constructor: function () {
            ...
            html = '<span class="col-md-2 focus-jfilestyle" style="padding-left:0px;padding-right:0px">'+
            ...
            _self.$elementjFilestyle = $('<div class="col-md-4 jfilestyle ' + (_self.options.input?'jfilestyle-corner':'') + ' ' + (this.options.buttonBefore ? ' jfilestyle-buttonbefore' : '') + '">'+html+'</div>');
