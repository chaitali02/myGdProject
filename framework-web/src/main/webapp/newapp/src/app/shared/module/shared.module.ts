...
@NgModule({
    ...
    exports: [CommonModule,ClockComponent,BreadcrumbComponent,D3Component,C3Component,ModelComponent],
    declarations: [ClockComponent,BreadcrumbComponent,D3Component,C3Component,ModelComponent],
})
