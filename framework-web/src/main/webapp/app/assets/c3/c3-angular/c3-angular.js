...
function ChartController($scope, $timeout) {
    ...
    this.addDataOnContexMenuFunction = addDataOnContexMenuFunction;
    ...
    function showGraph() {
        ...
        if ($scope.dataOnContexMenu != null) {
            config.data.contextmenu = function (data) {
                $scope.$apply(function () {
                    $scope.dataOnContexMenu({"data": data});
                });
            };
        }
    ...
    function addDataOnContexMenuFunction(theFunction) {
        $scope.dataOnContexMenu = theFunction;
    }
...
function ChartEvents() {
    var eventsLinker = function (scope, element, attrs, chartCtrl) {
        ...
        if (attrs.onContexMenu) {
        	
            chartCtrl.addDataOnContexMenuFunction(scope.onContexMenu);
        }
    };
