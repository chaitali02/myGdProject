...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
           ...
           //content.css('min-height', '1133px'); //jitender
        }
    };
    ...
    var handleSidebarMenuActiveLink = function (mode, el, $state) {
        ...
        if (mode === 'click' || mode === 'set') {
            ...
            menu.find('li > a').each(function () {
                ...
                if(typeof state === "undefined")
                	...
                	//alert(JSON.stringify(state.split("(")[0]))
                	 /*if(state.split("(")[0] == "metadata"){
                 		alert("dfdfdf")
                 		el = $(this);
                         return;
                 	}*/
                ...
                if ($state && state.split("(")[0]) {

                    if ($state.is(state.split("(")[0])) {
                        el = $(this);
        ...
        el.each(function(){ //jitender

        	$(".submenucheck").find("li").removeClass("active");
        });
        if (mode === 'click') {
