DROP TABLE EDW_SMALL.dim_account;
CREATE TABLE EDW_SMALL.dim_account(	ACCOUNT_ID VARCHAR(50) DEFAULT 0 NOT NULL,
	...
	LOAD_ID INTEGER, 
CONSTRAINT ACCOUNT_ID_DIM_PK  PRIMARY KEY(ACCOUNT_ID,LOAD_DATE,LOAD_ID),
