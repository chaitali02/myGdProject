 ...
 *
 */
public class TrainResultView extends BaseEntity {
	private MetaIdentifierHolder dependsOn;
	private List<ParamListHolder> paramList;
	 ...
	 */
	public List<ParamListHolder> getParamList() {
		return paramList;
	}
	/**
	 *
	 ...
	 */
	public void setParamList(List<ParamListHolder> paramList) {
