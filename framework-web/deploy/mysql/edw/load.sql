...
load data local infile '/user/hive/warehouse/framework/app/edw/data/csv/header/dim_state.csv' ignore into table dim_state fields terminated by ',' enclosed by '"' escaped by '"' lines terminated by '\n' ignore 1 lines;
load data local infile '/user/hive/warehouse/framework/app/edw/data/csv/header/dim_date.csv' ignore into table dim_date fields terminated by ',' enclosed by '"'   lines terminated by '\r' ignore 1 lines;
