...
var screenshot = function screenshot() {
   var screenshotController = function screenshotController($scope, $element, $compile, $timeout, $window) {
      ...
      var download = function download() {
        ...
        //  saveSvgAsPng(svg, 'Test.png',{"backgroundColor":"white","left":"-200","top":"-200","width":"2000"});
      ...
      self.rect = {};
      self.toolboxElement;
      self.cancelText = 'fa fa-times'//'Cancel';
      self.downloadText = 'fa fa-download'//'Download';
      self.downloadTextAll='fa fa-arrows-alt'
      self.filename = 'screenshot.png';
      self.setTemplate = setTemplate;
      self.template = '<div class="screenshot-toolbox">' + '<button title="Cancel" class="btn btn-circle btn-icon-only btn-default bg-red bg-hover-grey-salsa font-white borderless" type="button" ng-click="screenshotCtrl.cancel()"><i class="{{screenshotCtrl.cancelText}}" aria-hidden="true"></i></button>' + '<button title="Download Selected" class="btn btn-circle btn-icon-only btn-default bg-green bg-hover-grey-salsa font-white borderless" type="button" ng-click="screenshotCtrl.download()"><i class="{{screenshotCtrl.downloadText}}" aria-hidden="true"></i></button>' + '<button title="Download Fullscreen" class="btn btn-circle btn-icon-only btn-default bg-green bg-hover-grey-salsa font-white borderless" type="button" ng-click="screenshotCtrl.downloadFull()"><i class="{{screenshotCtrl.downloadTextAll}}" aria-hidden="true"></i></button>' +'</div>';
      //self.template ='<div class="btn-group-sm">'+ '<button class="btn btn-default btn-fab" ng-click="appCtrl.cancel()"> <i class="material-icons">close</i></button>'+'<button class="btn btn-success btn-fab" ng-click="appCtrl.download()"><i class="material-icons">download</i></button>'+'</div>';
