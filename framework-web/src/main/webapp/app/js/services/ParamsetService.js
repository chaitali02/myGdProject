...
DatascienceModule.service("ParamSetService", function ($http, ParamSetFactory, $q) {
  ...
  this.getOneByUuidandVersion = function (uuid, version, type) {
    var deferred = $q.defer();
    ParamSetFactory.findOneByUuidandVersion(uuid, version, type)
  ...
  this.submit = function (data, type, upd_tag) {
    var deferred = $q.defer();
    ParamSetFactory.submit(data, type, upd_tag).then(function (response) { onSuccess(response.data) }, function (response) { onError(response.data) });
    var onSuccess = function (response) {
      deferred.resolve({
        data: response
      });
