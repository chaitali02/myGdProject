...
AdminModule.factory('AdminRoleFactory',function($http,$location){
	var factory={};
...
AdminModule.service('AdminRoleService',function($q,AdminRoleFactory,sortFactory){

	this.getLatestByUuid=function(uuid,type){
		 var deferred = $q.defer();
		 AdminRoleFactory.findLatestByUuid(uuid,type).then(function(response){onSuccess(response.data)});
	...
	this.getOneById=function(id,type){
		   var deferred=$q.defer();
		   AdminRoleFactory.findOneById(id,type).then(function(response){onSuccess(response.data)});
		   var onSuccess=function(response){
		      deferred.resolve({
		                  data:rolejson
		              })
	...
	this.getGraphData=function(uuid,version,degree){
		 var deferred = $q.defer();
		 AdminRoleFactory.getGraphData(uuid,version,degree).then(function(response){onSuccess(response.data)});
	     var onSuccess=function(response){
	    	  deferred.resolve({
	              data:response
	          });
	...
	this.getOneByUuidAndVersion=function(uuid,version,type){
		 var deferred = $q.defer();
		 AdminRoleFactory.findgetOneByUuidAndVersion(uuid,version,type).then(function(response){onSuccess(response.data)});
		 var onSuccess=function(response){
		      deferred.resolve({
		                  data:response
	          });
	...
	this.getAllVersionByUuid=function(uuid,type){
		 var deferred = $q.defer();
		 AdminRoleFactory.findAllVersionByUuid(uuid,type).then(function(response){onSuccess(response.data)});
	     var onSuccess=function(response){
	    	  deferred.resolve({
	              data:response
	          });
	...
	this.getAllLatest=function(type){
		   var deferred=$q.defer();
		   AdminRoleFactory.findAllLatest(type).then(function(response){onSuccess(response)});
		     var onSuccess=function(response){
	 ...
	 this.getAll=function(type) {
	     var deferred = $q.defer();
	     AdminRoleFactory.findAll(type).then(function(response){onSuccess(response.data)});
	     var onSuccess=function(response){
