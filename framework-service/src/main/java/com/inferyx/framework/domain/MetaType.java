...
public enum MetaType {
	...
	simulateExec, train, trainExec, recon, reconExec, recongroup, recongroupExec,reconview;
	...
	public static List<MetaType> getMetaList() {
		return Arrays.asList(MetaType.activity, MetaType.algorithm, MetaType.application, MetaType.condition,
				...
				MetaType.train, MetaType.trainExec, MetaType.recon, MetaType.reconExec, MetaType.recongroup, MetaType.recongroupExec);
	}
	...
	public static List<MetaType> getMetaAdminList() {
		return Arrays.asList(MetaType.dagExec, MetaType.dqExec, MetaType.dqgroupExec, MetaType.loadExec,
				...
				MetaType.uploadExec, MetaType.predictExec, MetaType.simulateExec, MetaType.trainExec, MetaType.reconExec, MetaType.recongroupExec);
	}
}
