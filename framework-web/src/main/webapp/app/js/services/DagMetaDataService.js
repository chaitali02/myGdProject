  ...
  obj.gridOptionsResults.columnDefs.push(
    {
      ...
      cellTemplate: [
        ...
        '    <i class="fa fa-angle-down"></i></button>',
        '    <ul uib-dropdown-menu class="dropdown-menu-grid">',
        '       <li><a  ng-show ="[\'ingestExec\',\'dagexec\'].indexOf(grid.appScope.newType) != -1?false:true" ng-disabled="grid.appScope.newType.indexOf(\'batchexec\')!=-1?[\'COMPLETED\',\'PENDING\',\'TERMINATING\',\'FAILED\',\'RUNNING\',\'KILLED\',\'STARTING\',\'READY\',\'ABORTED\'].indexOf(row.entity.status)==-1:grid.appScope.newType.indexOf(\'train\')!=-1?[\'COMPLETED\'].indexOf(row.entity.status)==-1:grid.appScope.newType.indexOf(\'dagexec\')!=-1?[\'COMPLETED\',\'PENDING\',\'TERMINATING\',\'FAILED\',\'RUNNING\',\'KILLED\',\'STARTING\',\'READY\',\'ABORTED\'].indexOf(row.entity.status)==-1:grid.appScope.newType.indexOf(\'group\')==-1?[\'COMPLETED\'].indexOf(row.entity.status)==-1:[\'COMPLETED\',\'RUNNING\',\'KILLED\',\'FAILED\',\'TERMINATING\',\'STARTING\',\'READY\',\'ABORTED\'].indexOf(row.entity.status)==-1"  ng-click="grid.appScope.getExec(row.entity)"><i class="fa fa-eye" aria-hidden="true"></i> View </a></li>',
