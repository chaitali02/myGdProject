...
JobMonitoringModule.controller('IngestExecController', function ($filter, $state, $stateParams, $rootScope, $scope, $sessionStorage, JobMonitoringService, sortFactory, dagMetaDataService, privilegeSvc) {
    ...
    $scope.onShowDetail = function (data) {
        ...
        $rootScope.previousState.name = dagMetaDataService.elementDefs['ingestexec'].detailState;
    ...
    $scope.close = function () {
        if ($stateParams.returnBack == "true" && $rootScope.previousState) {
            ...
            if($rootScope.previousState.name!="resultgraphwf"){
                ...
                stateTabPrevious.route=dagMetaDataService.elementDefs['ingestexec'].detailState;;
                ...
                stateTabPrevious.param.type = dagMetaDataService.elementDefs['ingestexec'].execType;
            ...
            $scope.statedetail = {};
            $scope.statedetail.name = dagMetaDataService.elementDefs['ingestexec'].listState
            $scope.statedetail.params = {}
            $scope.statedetail.params.type = dagMetaDataService.elementDefs['ingestexec'].execType;
