...
export class PipelineExecComponent implements OnInit {
  ...
  onSuccessgetOneByUuidAndVersion(response) {
    ...
    //  this.operatorsUuid=response.operators[0].ref.type;
    // this.operatorsVrsion=response.operators[0].ref.name;

    if(this.dagResultData.stages[0].tasks[0].operators[0].operatorInfo.ref == null){
    this.dagResultData.stages[0].tasks[0].operators[0].operatorInfo.ref.type = null;
    this.dagResultData.stages[0].tasks[0].operators[0].operatorInfo.ref.name = null;
    }
  ...
  // getStagestatusList(statusList,index){
  //  console.log(statusList);
  //    this.dagResultData.stages[index].imgPath = this.statusDefs.getStatusDefs(statusList)['iconPath']
  //    console.log(this.dagResultData.stages[index].imgPath);
  // }
