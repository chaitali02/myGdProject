  ...
  JobMonitoringModule.controller('DetailOperatorExecController', function($filter, $state, $stateParams, $rootScope, $scope, $sessionStorage, JobMonitoringService, sortFactory, dagMetaDataService,privilegeSvc) {
    ...
    $scope.close = function() {
      if ($stateParams.returnBack == "true" && $rootScope.previousState) {
        ...
        if($rootScope.previousState.name!="resultgraphwf"){
          ...
          stateTabPrevious.route=dagMetaDataService.elementDefs['operatorexec'].detailState;;
          ...
          stateTabPrevious.param.type = dagMetaDataService.elementDefs['operatorexec'].execType;
    ...
    JobMonitoringService.getLatestByUuid($scope.uuid, "operatorexec")
    ...
    $scope.onShowDetailDepOn=function(data){
      ...
      $rootScope.previousState.name = dagMetaDataService.elementDefs['operatorexec'].detailState;
