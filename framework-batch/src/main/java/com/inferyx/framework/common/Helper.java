	...
	public static String getFileCustomNameByFileType(FileType fileType, String extension) {
		if(fileType != null)
			switch (fileType) {
				...
				case XLSX : return Helper.getNextUUID()+"_"+Helper.getVersion()+"."+extension;		
			}
		return null;
	}
	public static FileType getFileType(String fileType) {
		if(fileType != null)
			switch (fileType.toLowerCase()) {
				...
				case "xslx" : return FileType.XLSX;
			}
		return null;
	}
	public static String getFileDirectoryByFileType(FileType fileType) throws FileNotFoundException, IOException {
		if(fileType != null)
			switch (fileType) {
				...
				case XLSX : return getPropertyValue("framework.file.download.path");		
			}
		return null;
	}
}