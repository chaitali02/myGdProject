...
AdminModule.factory('AdminUserFactory',function($http,$location){
	var factory={};
...
AdminModule.service('AdminUserService',function($q,AdminUserFactory,sortFactory){
	...
	this.getOneById=function(id,type){
		   var deferred=$q.defer();
		   AdminUserFactory.findOneById(id,type).then(function(response){onSuccess(response.data)});
		   var onSuccess=function(response){
			  deferred.resolve({
		                  data:response
		              })
	...
	this.getGraphData=function(uuid,version,degree){
		 var deferred = $q.defer();
		 AdminUserFactory.getGraphData(uuid,version,degree).then(function(response){onSuccess(response.data)});
	     var onSuccess=function(response){
	    	  deferred.resolve({
	              data:response
	          });
	...
	this.getOneByUuidAndVersion=function(uuid,version,type){
		 var deferred = $q.defer();
		 AdminUserFactory.findgetOneByUuidAndVersion(uuid,version,type).then(function(response){onSuccess(response.data)});
		 var onSuccess=function(response){
			 deferred.resolve({
		                  data:response
	          });
	...
	this.getAllVersionByUuid=function(uuid,type){
		 var deferred = $q.defer();
		 AdminUserFactory.findAllVersionByUuid(uuid,type).then(function(response){onSuccess(response.data)});
	     var onSuccess=function(response){
	    	  deferred.resolve({
	              data:response
	          });
	...
	this.getAllLatest=function(type){
		   var deferred=$q.defer();
		   AdminUserFactory.findAllLatest(type).then(function(response){onSuccess(response)});
		     var onSuccess=function(response){
	 ...
	 this.getAll=function(type) {
	     var deferred = $q.defer();
	     AdminUserFactory.findAll(type).then(function(response){onSuccess(response.data)});
	     var onSuccess=function(response){
