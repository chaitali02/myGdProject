...
MetadataModule.controller('MetadataDashboardController2',function($state,$scope,$stateParams,$rootScope,$sessionStorage,$timeout,$filter,privilegeSvc,MetadataDahsboardSerivce){
	$scope.pageNo = 1;
