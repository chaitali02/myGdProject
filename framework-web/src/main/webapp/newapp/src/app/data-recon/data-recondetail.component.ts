...
import {AttributeHolder} from './../metadata/domain/domain.attributeHolder'
  ...
  export class DataReconDetailComponent{
    ...
    addRow(){
      ...
      // filertable["lhsFilter"] = this.sourceFilterAttribute[0]
      // filertable["logicalOperator"]=this.sourceFilterTable.length >0?this.logicalOperator[0]:"";
      // filertable["operator"] = this.operator[0].value
      // filertable["lhstype"] = this.lshType[0]
      // filertable["rhstype"] = this.rhsType[0]
      filertable["rhsvalue"];
      filertable["lhsvalue"];
