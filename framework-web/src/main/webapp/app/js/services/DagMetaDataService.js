...
InferyxApp.factory('dagMetaDataService',function($rootScope,$state, uiGridConstants){
  ...
  obj.elementDefs = {
    ...
    'paramlistdq':{
      ...
      parentIconCaption:'',
      allowInMenu : false,
      listState : 'paramlistdq',
      detailState:'createparamlistdq',
      childMenu:[],
      allowInChildMenu : false,
    },
    'paramlistreport':{
   ...
   'operator':{
    ...
    childMenu:['generatedata','transpose','clonedata','matrix','histogram','pca','datasampling','Customdq'],
    allowInChildMenu : false,
  },
  'operatorexec':{
    name : 'operatorexec',
   ...
   'logicaloperator':{
    ...
    'Customdq':{
      ...
      color : '#c6ff00',
      parentIconCaption:'',
      OperatorType:"CustomDq",
      childIconCaption:'Custom DQ',
      iconPath : 'assets/layouts/layout/img/operator.svg',
      detailState: 'createoperator',
      allowInMenu :false,
      listState : 'operator',
