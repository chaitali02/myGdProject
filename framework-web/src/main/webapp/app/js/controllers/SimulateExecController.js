...
JobMonitoringModule.controller('DetailSimulateExecController', function ($filter, $state, $stateParams, $rootScope, $scope, $sessionStorage, JobMonitoringService, sortFactory, dagMetaDataService,privilegeSvc) {
  ...
  $scope.close = function () {
    if ($stateParams.returnBack == "true" && $rootScope.previousState) {
      ...
      if($rootScope.previousState.name!="resultgraphwf"){
        ...
        stateTabPrevious.route=dagMetaDataService.elementDefs['simulateexec'].detailState;;
        ...
        stateTabPrevious.param.type = dagMetaDataService.elementDefs['simulateexec'].execType;
  ...
  JobMonitoringService.getLatestByUuid($scope.uuid, "simulateexec")
  ...
  $scope.onShowDetailDepOn=function(data){
    ...
    $rootScope.previousState.name = dagMetaDataService.elementDefs['simulateexec'].detailState;
