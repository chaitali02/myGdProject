...
JobMonitoringModule.controller('DetailTrainExecController', function ($filter, $state, $stateParams, $rootScope, $scope, $sessionStorage, JobMonitoringService, sortFactory, dagMetaDataService) {
  ...
  JobMonitoringService.getLatestByUuid($scope.uuid, "trainexec").then(function (response) {
