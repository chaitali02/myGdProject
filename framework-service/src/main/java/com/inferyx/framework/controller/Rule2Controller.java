...
public class Rule2Controller {
	...
	public String getRule2Sql(@RequestBody Rule2 rule,
		...
		return rule2Operator.generateDetailSql(rule, null, null, usedRefKeySet, null, RunMode.ONLINE);
	}
	...
	public MetaIdentifier create(@RequestParam("uuid") String ruleUUID,
			...
			@RequestParam(value = "type", required = false) String type,
			@RequestParam(value = "action", required = false) String action) throws Exception {
		RuleExec ruleExec = rule2ServiceImpl.create(ruleUUID, ruleVersion, null, null, execParams, null, null);
