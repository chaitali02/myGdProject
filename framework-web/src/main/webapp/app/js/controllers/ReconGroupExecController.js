...
JobMonitoringModule.controller('DetailReconGroupExecController', function ($filter, $state, $stateParams, $rootScope, $scope, $sessionStorage, JobMonitoringService, sortFactory, dagMetaDataService,privilegeSvc) {
    ...
    $scope.selectTitle = dagMetaDataService.elementDefs['recongroupexec'].caption;
    ...
    $scope.onShowDetail = function (data) {
        ...
        $rootScope.previousState.name = dagMetaDataService.elementDefs['recongroupexec'].detailState;
    ...
    $scope.state = dagMetaDataService.elementDefs['recongroupexec'].listState + "({type:'" + dagMetaDataService.elementDefs['recongroupexec'].execType + "'})"
    $scope.close = function () {
        if ($stateParams.returnBack == "true" && $rootScope.previousState) {
            ...
            if($rootScope.previousState.name!="resultgraphwf"){
                ...
                stateTabPrevious.route=dagMetaDataService.elementDefs['recongroupexec'].detailState;;
                ...
                stateTabPrevious.param.type = dagMetaDataService.elementDefs['maprecongroupexecexec'].execType;
            ...
            $scope.statedetail = {};
            $scope.statedetail.name = dagMetaDataService.elementDefs['recongroupexec'].listState
            $scope.statedetail.params = {}
            $scope.statedetail.params.type = dagMetaDataService.elementDefs['recongroupexec'].execType;
            $state.go($scope.statedetail.name, $scope.statedetail.params)
        }
    }


    JobMonitoringService.getLatestByUuid($scope.uuid, "recongroupexec")
