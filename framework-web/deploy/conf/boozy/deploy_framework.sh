...
cp deploy/conf/boozy/pom.xml .
cp deploy/conf/boozy/core-site.xml src/main/resources
cp deploy/conf/boozy/hdfs-site.xml src/main/resources
cp deploy/conf/boozy/hive-site.xml src/main/resources
cp deploy/conf/boozy/yarn-site.xml src/main/resources
cp deploy/conf/boozy/log4j.properties src/main/resources
cp deploy/conf/boozy/framework.properties src/main/resources
cp deploy/conf/boozy/framework_ui.properties src/main/webapp/app/resources/framework.properties
